...
function App() {
  ...
  return (
    <>
      ...
      <input type="search" value={bookTitle} className='text-color' onChange={(e) => setBookTitle(e.target.value)} />
      <button onClick={handleSearch} className='text-color btn btn-primary' class="">Search</button>
      <ul>
