...
function App() {
  ...
  return (
    <>
      ...
      <input type="search" value={bookTitle} className='text-color-black' onChange={(e) => setBookTitle(e.target.value)} />
      <button onClick={handleSearch} className='text-color-black btn btn-primary'>Search</button>
      <ul>
