...
function App() {
  ...
  return (
    <>
      ...
      <input type="text" value={bookTitle} className='text-color-black' onChange={(e) => setBookTitle(e.target.value)} placeholder='Book Title'/>
      <input type="text" id="customInput" class="custom-input" placeholder="Type something..." />
