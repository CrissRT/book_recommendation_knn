...
function App() {
  ...
  return (
    <>
      ...
      <input type="text" value={bookTitle} className='text-color-black'  placeholder='Book Title'/>
      <input type="text" id="customInput" class="custom-input" onChange={(e) => setBookTitle(e.target.value)} placeholder="Book Title" />
